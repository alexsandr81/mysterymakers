...
✔ Добавили миниатюры изображений в таблицу товаров.
✔ Добавили экспорт товаров в CSV (Excel).
✅ Добавлена возможность скрывать и показывать товары.
✅ Фильтр по статусу (Активен/Скрыт).
✅ Клиенты не видят скрытые товары.