...
✔ Фильтрация товаров (категория, цена, наличие)
✔ Сортировка товаров (дата, цена)
✔ Массовое удаление товаров

🚀 Итоги работы над products.php (Управление товарами)
✅ Фильтры встроены в заголовки таблицы (экономия места, удобство).
✅ Фильтр по категории, подкатегории, размеру, материалу (выбор из списка).
✅ Фильтр по артикулу (поиск + сортировка по возрастанию/убыванию).
✅ Фильтр по количеству (по возрастанию/убыванию).
✅ Фильтр по названию файла (сортировка по А-Я / Я-А).
✅ Фильтрация работает без перезагрузки страницы (AJAX-параметры в URL).
✅ Данные обновляются корректно, сортировка и фильтрация стабильны.
✅ Код оптимизирован и удобен для будущих изменений.

✅ Теперь количество можно изменять прямо в таблице!
✅ Товары с низким остатком (stock < 5) выделяются красным!
✅ Добавлена сортировка по дате добавления!
✅ Мгновенное редактирование количества товаров прямо в таблице (без перезагрузки).

Мы уже сделали:
✅ Фильтры, сортировку, поиск по категории, подкатегории, размеру, материалу, артикулу.
✅ Редактирование количества товаров прямо в таблице (AJAX).
✅ Миниатюры изображений товаров в таблице.
✅ Экспорт списка товаров в CSV (Excel).
✅ Добавили возможность скрывать товары (они не видны клиенту).

✅ Оборот за день, неделю, месяц.
✅ Количество новых заказов и их статус.
✅ Оставшиеся товары на складе.
✅ Популярные товары.
✅ График продаж.
✔ Оборот за день, неделю, месяц (автоматический подсчёт).
✔ Количество новых заказов и их статус (новые, в обработке, выполненные).
✔ Оставшиеся товары на складе (считаем товары с низким остатком).
✔ Популярные товары (по количеству продаж).
✔ График продаж за последние 7 дней (на Chart.js).

✅ SEO-данные теперь сохраняются при добавлении товара!
✅ Slug (ЧПУ-ссылка) генерируется автоматически!
✅ Все данные корректно записываются в базу!

✅ SEO-данные теперь можно редактировать в товарах!
✅ Slug (ЧПУ-ссылка) обновляется при изменении названия!
✅ Все изменения корректно записываются в базу!

✅ SEO-данные теперь можно добавлять и редактировать в товарах.
✅ Slug (ЧПУ-ссылка) генерируется автоматически.
✅ Все данные корректно записываются в базу.

✅ SEO-данные теперь используются на странице товара!
✅ <title> и <meta> подставляются автоматически!
✅ Если SEO не задано – используются стандартные значения!

✅ SEO-данные теперь сохраняются при добавлении категории!
✅ Slug (ЧПУ-ссылка) генерируется автоматически!
✅ Все данные корректно записываются в базу!

✅ Теперь можно редактировать SEO у категорий!

✅ Боковое меню с выпадающими списками подкатегорий.
✅ Фильтрация товаров по категориям и подкатегориям.
✅ AJAX-добавление в корзину и избранное.
✅ Постраничная навигация.
✅ SEO (<title>, <meta>) подгружается из базы.
Теперь скрытые товары больше не отображаются в каталоге!
✅ Пользователи видят только активные товары (status = 1)